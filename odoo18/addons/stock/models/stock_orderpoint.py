...
class StockWarehouseOrderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity specified for this field,  generates "
    ...
    product_max_qty = fields.Float(
        ...
        help="When the virtual stock goes below the Min Quantity,  generates "
